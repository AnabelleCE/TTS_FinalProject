...
#this pulls fiancial data from json
getSymbols("AMZN", from="2016-01-01", to="2020-01-01") #to get the data for a spcific ticker/stock
View(AMZN) #to view the table fromt he created dataset
